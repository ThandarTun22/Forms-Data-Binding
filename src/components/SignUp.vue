<template>
    <form @submit.prevent="submit">
        ...
        <div>
           <input type="checkbox" value="hlaingminthan" v-model="names">
           <label for="">Hlaing Min Than</label>
        </div>
         <div>
         ...
         <div>
           <input type="checkbox" value="koko" v-model="names">
